    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAdmin">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="userDashbord"><ion-icon name="home-outline"></ion-icon> Home</a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link" href="getAllProduct"><ion-icon name="construct-outline"></ion-icon> Products</a>
                </li>
